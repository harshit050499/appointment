(function (factry) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        define(['jquery', 'moment'], factry);
    }
    else if (typeof exports === 'object') {
        // Node/CommonJS
        factry(require('jquery'), require('moment'));
    }
    else {
        // Browser globals
        factry(jQuery, moment);
    }
}(function ($, moment) {
    // Namespace
    ...
    var clndrUI =
        "<div class='clndr-controls'>" +
            "<div class='clndr-control-button'>" +
                "<span class='clndr-previous-button'><i class='fa fa-caret-left' aria-hidden='true' style='font-size:20px;color:white;'></i></span>" +
            "</div>" +
            "<div class='month'><%= month %> <%= year %></div>" +
            "<div class='clndr-control-button rightalign'>" +
                "<span class='clndr-next-button'><i class='fa fa-caret-right' aria-hidden='true' style='font-size:20px;color:white;'></i></span>" +
            "</div>" +
        "</div>" +
